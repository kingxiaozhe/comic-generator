...
// DeepSeek API配置
const DEEPSEEK_API_URL = "https://api.siliconflow.cn/v1/chat/completions"; // 修正为正确的API端点
const DEEPSEEK_API_KEY = "sk-xgpdmqrgikwkbaacvxbvtkwhxnwjncdvqzlshnzcyswxhsfn"; // 用户提供的API密钥
